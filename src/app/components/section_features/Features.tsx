        ...
        <div className={Styles.section_features}>
            <Container>
                <div className={Styles.container}>
                    ...
                    <Bookmarking
                        visibility={addEffectItem02}
                        image="images/illustration-features-tab-2.svg"
                        title='Intelligent search'
                        text='Our powerful search will help you find saved sites in nontime at all. No need to trawl through all of your bookmarks.'
                        textButton='More info' />
                    <Bookmarking
                        visibility={addEffectItem03}
                        image="images/illustration-features-tab-3.svg"
                        title='Share your bookmarks'
                        text='Easily share your bookmarks and collections with others. Create a shareble'
                        textButton='More info' />
                </div>
            </Container>
        </div>
